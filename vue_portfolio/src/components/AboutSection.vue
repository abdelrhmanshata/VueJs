    ...
    >
      ...
      >
        ...
        <p class="text-base lg:text-lg mt-8 py-8">
          A versatile software developer who is passionate about building
          reliable and easy-to-use solutions. I have a solid background in both
          front-end and back-end development, and I have a strong desire to
          learn and use new technologies. Demonstrated capacity for adaptation
          and success in hectic settings; dedicated to providing excellent
          solutions and fostering teamwork to spur innovation.
        </p>
